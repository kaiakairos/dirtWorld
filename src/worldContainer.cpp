...
void WORLDCONTAINER::chunkLoadArea(int centerChunkX, int centerChunkY, int loadWidth, int loadHeight){
    ...
    Array chunks = get_children(); // array of vector2i's of existing chunks

    for( int i = 0; i < get_child_count(); i++ ){ // parse through keys to detect chunks that should be deleted
